entities = [
...

    {
        ...
        'table_name': 'stream',
        'pk': 'id',
        'query_to_get_data': '''SELECT id, start_at, end_at, created_at,
                                       updated_at, deleted_at, is_open,
...

    {
        ...
        'table_name': 'course',
        'pk': 'id',
        'query_to_get_data': '''SELECT id, title, created_at, updated_at,
                                       deleted_at, icon_url, is_auto_course_enroll,
                                       is_demo_enroll
                                       FROM course''',
    },
